function Skills(props){
    ...
    return(
        <div id="Skills" style={{padding:props.isSmallScreen? 50:75}}>
            <p style={{ color: props.darkMode ? 'rgb(255,255,255)' : 'rgb(17,17,17)', fontWeight: 'bold', fontSize: 28, marginBottom: 25, marginLeft:10 }}>
                SKILLS
            </p>
            <div style={{ display: 'flex', justifyContent: 'space-around', flexDirection: props.isSmallScreen ? 'column' : 'row'}}>
                ...
                <div style={{ flexDirection: 'column', marginLeft: props.isSmallScreen ? 20 : 0, marginBottom:props.isSmallScreen ? 40 : 0 }}>
                    ...
                    <p style={{color:props.darkMode ? 'rgb(230,230,230)' : 'rgb(17,17,17)'}}>Next.js</p>
